...
Most projects use only the Python standard library. For projects with external libs:
```bash
pip install -r requirements.txt
```

Check each project's folder for its own `README.md` with specific instructions.
...
3. Commit changes: `git commit -m "Add new project: X"`
...
- LinkedIn: [Add your LinkedIn here](https://www.linkedin.com/in/vasudev-karthik-b889272a7/)
...
1. **Add screenshots**: For GUI projects like `TextEditor` or `tictactoe`, add a `/screenshots` folder and embed them: `![TicTacToe Demo](./screenshots/tictactoe.png)`
